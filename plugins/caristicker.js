...
let handler = async(m, { conn, text }) => {
  ...
  await m.reply('Searching...')
    let json = await (await fetch('https://api.zeks.xyz/api/searchsticker?apikey=apivinz&q=' + text)).json()
    ...
    let hasil = await sticker(buffer, false, 'Sticker Search', 'Kuhong Bot')
